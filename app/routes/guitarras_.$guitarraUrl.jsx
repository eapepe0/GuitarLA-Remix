...
export async function loader({ params }){ //* este es un loader de Remix , consume datos de una API
...
export function meta({data}){ //* aca va la info en los tags <meta>
...
function Guitarra() {
  ...
  return (
      <div className="guitarra">
        <img className='imagen' src={medium} alt={`Imagen de la guitarra ${nombre}`} />
        <div className="contenido">
          ...
          <form className="formulario" onSubmit={handleSubmit}>
            ...
            <select className='select' name="" id="cantidad" onChange={ e => setCantidad( parseInt( e.target.value))}>
